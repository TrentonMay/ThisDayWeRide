...
<div class="container col-lg-7 col-md-7 col-sm-12 user-cont right">
    <ul class="container col-lg-12 col-md-12 col-sm-12 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
        <?php
        foreach($userArray as $out){
            echo '<li class="col-lg-12 col-md-12 col-sm-12">';
            echo '<ul class="container col-lg-12 col-md-12 col-sm-12 users-row">';

            echo '<li class="col-lg-1 col-md-1 col-sm-1 left user-style">';
            echo "<p>". $out['userid']. "</p>";
            echo '</li>';

            echo '<li class="col-lg-2 col-md-2 col-sm-2 left user-style">';
            echo "<p>". $out['username']. "</p>";
            echo '</li>';

            echo '<li class="col-lg-3 col-md-3 col-sm-3 left user-style">';
            echo "<p>". $out['email']. "</p>";
            echo '</li>';

            echo '<li class="col-lg-4 col-md-4 col-sm-4 left user-style">';
