...
<div class="container-fluid banner-v4">
    ...
    <div class="container col-lg-6 col-md-6 col-sm-6 menu menuV5">
        <ul class="container col-lg-12 col-md-12 col-sm-12">
            ...
            <li class="col-lg-3 col-md-3 col-sm-3"><a href="<?php echo site_url("Users/index") ?>">Users</a></li>
            <li class="col-lg-3 col-md-3 col-sm-3"><a href="<?php echo site_url("Rides/adminRides")?>">Rides</a></li>
            <li class="col-lg-3 col-md-3 col-sm-3"><a href="<?php echo site_url("Bikes/adminBikes")?>">Bikes</a></li>
        </ul>
    </div>
...
<div class="container col-lg-4 col-md-4 col-sm-12 form-style form-style-v2 left">
    <form class='form-horizontal' enctype='multipart/form-data' action='<?php echo site_url('Bikes/updateBike/'.$bikeData[0]['bikeid']); ?>' method='post'>
        ...
        <div class='container col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 left'>
            <input class='form-control form1-margin' type='text' id='model' name='model' placeholder='Bike Model' value="<?php $nodata=" "; if(isset($bikeData[0]['model'])){echo $bikeData[0]['model'];}else{echo $nodata;} ?>">
        </div>
        <div class="container col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 left">
            <input class="form-control form1-margin" type="text" id="username" name="username" placeholder="Username" value="<?php if(isset($bikeData[0]['username'])){echo $bikeData[0]['username'];}else{echo $nodata;} ?>">
        </div>
        <div class="container col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 left">
            <input class="form-control form1-margin" type="text" id="image" name="image" placeholder="image link" value="<?php if(isset($bikeData[0]['image'])){echo $bikeData[0]['image'];}else{echo $nodata;} ?>">
        </div>
        <div class="container col-lg-6 col-md-6 col-sm-6 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 left">
