...
<div class="container-fluid banner-v4">
    ...
    <div class="container col-lg-6 col-md-6 col-sm-6 menu menuV3">
        <ul class="container col-lg-12 col-md-12 col-sm-12">
            ...
            <li class="col-lg-3 col-md-3 col-sm-3"><a href="<?php echo site_url("Bikes/index")?>">Bikes</a></li>
        </ul>
    </div>
    <h3 class="right dark-head">Welcome (User)</h3>
</div>
